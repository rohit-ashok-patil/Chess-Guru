...
# # Maia-2 style FEN to tensor conversion function
# piece_to_plane = {
#     'P': 0, 'N': 1, 'B': 2, 'R': 3, 'Q': 4, 'K': 5,
#     'p': 6, 'n': 7, 'b': 8, 'r': 9, 'q': 10, 'k': 11
# }

# def fen_to_maia2_tensor(fen):
...
#     # Castling rights (4 planes: WK, WQ, BK, BQ)
...
# input_csv = "positions_with_move_index2.csv"  # Must exist!
# output_dir = "tensor_data_maia22"             # Directory to save .npy tensors
# metadata_csv = "tensor_metadata_maia22.csv"   # Metadata CSV
...
# with open(metadata_csv, 'w', newline='', encoding='utf-8') as metafile:
#     fieldnames = ['TensorFile', 'MoveIndex']
#     writer = csv.DictWriter(metafile, fieldnames=fieldnames)
#     writer.writeheader()

#     for idx, row in tqdm(df.iterrows(), total=total_positions, desc="Encoding positions"):
#         fen = row['FEN']
#         move_index = row['MoveIndex']
#         tensor = fen_to_maia2_tensor(fen)
#         tensor_file = f"tensor_{idx}.npy"
#         np.save(os.path.join(output_dir, tensor_file), tensor)
#         writer.writerow({'TensorFile': tensor_file, 'MoveIndex': move_index})

# print(f"Done! Processed {total_positions} positions. Tensors saved in '{output_dir}' and metadata in '{metadata_csv}'.")
...
# # Input and output files
# input_csv = "positions_with_move_index3.csv"  # Must exist!
# output_dir = "tensor_data_maia23"             # Directory to save .npy tensors
# metadata_csv = "tensor_metadata_maia23.csv"   # Metadata CSV
